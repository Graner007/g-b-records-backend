...
var resolvers = {
    Query: {
        ...
        recordsBetweenTwoPrice: function (_parent, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            var records, currentUser, wishlistProductsIds, newRecords, _i, records_1, record;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        currentUser = _b.sent();
                        wishlistProductsIds = (_a = currentUser.wishlist) === null || _a === void 0 ? void 0 : _a.products.map(function (product) { return product.id; });
                        newRecords = [];
