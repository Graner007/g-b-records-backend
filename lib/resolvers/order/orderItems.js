...
var resolvers = {
    Query: {
        orderItems: function (_parent, _args, context) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, context.prisma.orderItem.findMany()];
            });
        }); }
    },
    Mutation: {
        successfulPayment: function (_parent, _args, context) { return __awaiter(void 0, void 0, void 0, function () {
            var currentUser, payment_1, productNumber_1, newOrder_1;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        currentUser = _d.sent();
                        if (!(((_a = currentUser.cart) === null || _a === void 0 ? void 0 : _a.products) !== [])) return [3, 4];
                        payment_1 = 0;
                        productNumber_1 = 0;
                        (_b = currentUser.cart) === null || _b === void 0 ? void 0 : _b.products.forEach(function (product) {
                    ...
                    case 2:
                        newOrder_1 = _d.sent();
                        (_c = currentUser.cart) === null || _c === void 0 ? void 0 : _c.products.map(function (product) {
                    ...
                    case 4: throw new Error("Cart is empty");
                }
            });
        }); }
    }
