...
var resolvers = {
    ...
    Mutation: {
        successfulPayment: function (_parent, _args, context) { return __awaiter(void 0, void 0, void 0, function () {
            var currentUser, payment, productNumber, newOrder;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        payment = 0;
                        productNumber = 0;
                        (_a = currentUser.cart) === null || _a === void 0 ? void 0 : _a.products.forEach(function (product) {
                    ...
                    case 2:
                        newOrder = _c.sent();
                        (_b = currentUser.cart) === null || _b === void 0 ? void 0 : _b.products.map(function (product) {
                    ...
                    case 3:
                        _c.sent();
                        return [2, orderUtils_1.order({ orderId: newOrder.id }, context)];
                }
            });
        }); }
    }
