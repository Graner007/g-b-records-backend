...
var recordUtils_1 = require("./recordUtils");
var resolvers = {
    Query: {
        ...
        category: function (_parent, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            var where, records, count, minPrice, maxPrice, currentUser, newRecords;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        where = {
                    ...
                    case 2:
                        ...
                        if (!(context.userId !== null && records !== [] && records.length > 0)) return [3, 4];
                    ...
                    case 3:
                        ...
                        newRecords = recordUtils_1.getRecordsWithInWishlistField(records, currentUser.wishlist.products);
                        return [2, { records: newRecords, count: count, minPrice: minPrice, maxPrice: maxPrice }];
                    case 4: return [2, { records: records, count: count, minPrice: minPrice, maxPrice: maxPrice }];
                }
            });
        }); },
        recordsBetweenTwoPrice: function (_parent, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            var records, currentUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        currentUser = _a.sent();
                        return [2, recordUtils_1.getRecordsWithInWishlistField(records, currentUser.wishlist.products)];
                    case 3: return [2, records];
                }
            });
        }); },
        recommendedRecords: function (_parent, _args, context) { return __awaiter(void 0, void 0, void 0, function () {
            var currentUser, searchRecords, names, recommendedRecords;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(context.userId !== null)) return [3, 4];
                        return [4, userUtils_1.user(context)];
                    case 1:
                        currentUser = _a.sent();
                    ...
                    case 2:
                        ...
                        if (searchRecords && searchRecords.length < 1) {
                            return [2, recordUtils_1.latestRecords(context)];
                        }
                        return [4, context.prisma.record.findMany({
                                where: {
                                    name: {
                    ...
                    case 3:
                        recommendedRecords = _a.sent();
                        return [2, recordUtils_1.getRecordsWithInWishlistField(recommendedRecords, currentUser.wishlist.products)];
                    case 4: return [2, recordUtils_1.latestRecords(context)];
                }
            });
        }); },
