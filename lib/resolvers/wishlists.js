        ...
        toggleProductInWhislist: function (_parent, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        user = _d.sent();
                        record = (_a = user === null || user === void 0 ? void 0 : user.wishlist) === null || _a === void 0 ? void 0 : _a.products.find(function (product) { return product.id === args.recordId; });
                        if (!record) {
                            return [2, context.prisma.wishlist.update({
                                    where: {
                                        id: (_b = user === null || user === void 0 ? void 0 : user.wishlist) === null || _b === void 0 ? void 0 : _b.id
                                    },
                                    select: {
                                        products: true
                                    },
                            ...
                            return [2, context.prisma.wishlist.update({
                                    where: {
                                        id: (_c = user === null || user === void 0 ? void 0 : user.wishlist) === null || _c === void 0 ? void 0 : _c.id
                                    },
                                    select: {
                                        products: true
                                    },
